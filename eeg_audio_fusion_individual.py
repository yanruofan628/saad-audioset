...
3. 运行脚本：python eeg_audio_fusion_individual.py
...
if __name__ == "__main__":
    ...
    SUBJECT_TO_PROCESS = 'yanxingzhuo'  # 可选: 'hanglei', 'yanxingzhuo', 'jinxiaoyue', 'chenxianwei', 'yeziyuan', 'zhangzhiyao', 'haoxiang'
